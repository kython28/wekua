...
pub fn main() !void {
    ...
    inline for (modules) |module| {
        ...
        try stdout.print("{s: ^10} | {d: ^10}{d: ^10}{d: ^10}{d: ^10}{d: ^10}{d: ^10}{d: ^10}\n", .{
            "Library", 64, 128, 256, 512, 1024, 2048, 4096
        });
        for (reports) |report| {
            try stdout.print("{s: <10} | {d: ^10.3}{d: ^10.3}{d: ^10.3}{d: ^10.3}{d: ^10.3}{d: ^10.3}{d: ^10.3}\n", .{
