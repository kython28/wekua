...
test {
    ...
    wekua.utils.work_items.get(global_work_items[0..1], local_work_items[0..1], 1024);
    wekua.utils.work_items.get(global_work_items[0..2], local_work_items[1..3], 512);
    wekua.utils.work_items.get(global_work_items[0..3], local_work_items[3..6], 2024);
    wekua.utils.work_items.get(global_work_items[0..4], local_work_items[6..10], 64);
    wekua.utils.work_items.get(global_work_items[0..5], local_work_items[10..15], 4096);
